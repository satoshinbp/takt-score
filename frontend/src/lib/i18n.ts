...
const en = {
  ...
  "innerTakt.statusSilent": "SILENT — KEEP THE TAKT",
  "innerTakt.statusAudible": "AUDIBLE",
  "innerTakt.start": "Start",
  "innerTakt.stop": "Stop",
  "innerTakt.resetTaps": "Reset Taps",
  "innerTakt.shortcutsHint":
    "SPACE: tap · ESC: stop · R: reset taps · scroll/drag knobs",
  "innerTakt.knob.bpm": "BPM",
  "innerTakt.knob.beatsPerBar": "BEATS / BAR",
  "innerTakt.knob.accent": "ACCENT",
  "innerTakt.knob.accentUnitOne": "every {count} beat",
  "innerTakt.knob.accentUnitOther": "every {count} beats",
  "innerTakt.knob.audible": "AUDIBLE",
  "innerTakt.knob.silent": "SILENT",
  "innerTakt.knob.fade": "FADE",
  "innerTakt.unit.bars": "bars",
  "innerTakt.unit.beats": "beats",
  "innerTakt.stats.mean": "MEAN",
  "innerTakt.stats.stdev": "STDEV",
  "innerTakt.stats.best": "BEST",
  "innerTakt.stats.worst": "WORST",
  "innerTakt.timing.deviation": "TIMING DEVIATION",
  "innerTakt.timing.early": "EARLY",
  "innerTakt.timing.late": "LATE",
} as const;
...
const ja: Record<DictKey, string> = {
  ...
  "innerTakt.statusSilent": "サイレント — テンポを保て",
  "innerTakt.statusAudible": "発音中",
  "innerTakt.start": "開始",
  "innerTakt.stop": "停止",
  "innerTakt.resetTaps": "タップをリセット",
  "innerTakt.shortcutsHint":
    "SPACE: タップ · ESC: 停止 · R: タップリセット · スクロール/ドラッグでノブ操作",
  "innerTakt.knob.bpm": "BPM",
  "innerTakt.knob.beatsPerBar": "ビート/小節",
  "innerTakt.knob.accent": "アクセント",
  "innerTakt.knob.accentUnitOne": "{count}拍ごと",
  "innerTakt.knob.accentUnitOther": "{count}拍ごと",
  "innerTakt.knob.audible": "発音",
  "innerTakt.knob.silent": "無音",
  "innerTakt.knob.fade": "フェード",
  "innerTakt.unit.bars": "小節",
  "innerTakt.unit.beats": "拍",
  "innerTakt.stats.mean": "平均",
  "innerTakt.stats.stdev": "標準偏差",
  "innerTakt.stats.best": "ベスト",
  "innerTakt.stats.worst": "ワースト",
  "innerTakt.timing.deviation": "タイミング誤差",
  "innerTakt.timing.early": "早い",
  "innerTakt.timing.late": "遅い",
};
