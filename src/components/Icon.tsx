...
export const DrumIcon = ({ id, color, size = 20 }: DrumIconProps) => {
  ...
  const icons: Record<PartId, React.ReactNode> = {
    CRASH: (
      <svg width={w} height={h} viewBox={vb}>
        ...
        <g transform="rotate(-14,14,7)">
          ...
          <circle cx="14" cy="7" r="1.3" fill={color} stroke="none" opacity={0.8} />
        </g>
      </svg>
    ),
    RIDE: (
      <svg width={w} height={h} viewBox={vb}>
        ...
        <ellipse cx="14" cy="10" rx="3.5" ry="1.4" stroke={color} strokeWidth={1.2} fill={`${color}55`} />
    ...
    HI_TOM: (
      <svg width={w} height={h} viewBox={vb}>
        ...
        <ellipse cx="14" cy="19" rx="6" ry="1.6" stroke={color} strokeWidth={0.8} fill="none" opacity={0.35} />
        <line x1="8" y1="11" x2="8.4" y2="15" stroke={color} strokeWidth={1} opacity={0.5} />
    ...
    MID_TOM: (
      <svg width={w} height={h} viewBox={vb}>
        ...
        <ellipse cx="14" cy="19" rx="8.5" ry="1.8" stroke={color} strokeWidth={0.8} fill="none" opacity={0.35} />
        <line x1="5.5" y1="10" x2="6" y2="15" stroke={color} strokeWidth={1} opacity={0.5} />
    ...
    SNARE: (
      <svg width={w} height={h} viewBox={vb}>
        ...
        <ellipse cx="14" cy="16" rx="10" ry="2.5" stroke={color} strokeWidth={1} fill="none" opacity={0.55} />
        <line x1="6.5" y1="15.5" x2="21.5" y2="15.5" stroke={color} strokeWidth={0.7} strokeDasharray="2,1.2" opacity={0.9} />
        <line x1="6.5" y1="17" x2="21.5" y2="17" stroke={color} strokeWidth={0.7} strokeDasharray="2,1.2" opacity={0.7} />
        <line x1="6.5" y1="18.3" x2="21.5" y2="18.3" stroke={color} strokeWidth={0.7} strokeDasharray="2,1.2" opacity={0.5} />
        <line x1="4" y1="9" x2="4" y2="14" stroke={color} strokeWidth={1.5} opacity={0.5} />
    ...
    LO_TOM: (
      <svg width={w} height={h} viewBox={vb}>
        ...
        <ellipse cx="14" cy="17" rx="12" ry="2.5" stroke={color} strokeWidth={0.8} fill="none" opacity={0.35} />
    ...
    BD: (
      <svg width={w} height={h} viewBox={vb}>
        ...
        <circle cx="14" cy="11" r="7.5" stroke={color} strokeWidth={0.8} fill="none" opacity={0.45} />
        <circle cx="14" cy="11" r="1.5" fill={color} opacity={0.75} stroke="none" />
        <line x1="14" y1="20.5" x2="14" y2="22" stroke={color} strokeWidth={1.2} opacity={0.55} />
        <line x1="12" y1="21.5" x2="16" y2="21.5" stroke={color} strokeWidth={1} opacity={0.45} />
      </svg>
    ),
  };
  ...
  return (
    icons[id] ?? (
      <svg width={w} height={h} viewBox={vb}>
        <circle cx="14" cy="11" r="5" stroke={color} strokeWidth={1.5} fill={`${color}25`} />
      </svg>
    )
  );
};
